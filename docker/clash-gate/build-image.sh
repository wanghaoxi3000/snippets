...
curl -LO https://github.com/MetaCubeX/mihomo/releases/download/${CLASH_VERSION}/mihomo-linux-amd64-v1-${CLASH_VERSION}.gz
gzip -d mihomo-linux-amd64-v1-${CLASH_VERSION}.gz
mv mihomo-linux-amd64-v1-${CLASH_VERSION} clash-meta
...
echo
echo "Clean resource"
rm -rf mihomo-linux-amd64-compatible-go120-${CLASH_VERSION}.gz compressed-dist.tgz clash-meta config/ui
